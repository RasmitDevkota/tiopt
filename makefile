...
# Source files (C)
C_SRC = ti_utils.c experiments.c verlet.c electrodynamics.c io.c main.c transport.c

# Object files
C_OBJ = ti_utils.o experiments.o verlet.o electrodynamics.o io.o main.o transport.o
